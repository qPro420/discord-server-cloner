...
(async function() {
    setTitle("IoTa Cloner | Developer: qPro#0001");
    console.log(" ");
    console.log(" ");
    console.log(center(`IoTa Discord Server Cloner`.green, 112));
    ...
    console.log(" ");
    console.log(" ");
    let token = await question(('- Insert Your Discord Account Token: '.green));
    let copy = await question(('- Insert Server ID that you want to Copy: '.green));
    let paste = await question(('- Insert Server ID that you want to Paste: '.green));
    ...
    client.on("ready", async() => {
        ...
        setTitle("IoTa Cloner | Cloning Discord Server | Developer: qPro#0001");
        ...
        let guildname = guild1.name + " - IoTa Cloner";
        ...
        console.log(" ");
        log.info('Server Has Successfully Been Cloned By Iota Tools.')
    })
